...
Source0  : https://linuxtv.org/downloads/v4l-utils/v4l-utils-1.28.0.tar.xz
Source1  : https://linuxtv.org/downloads/v4l-utils/v4l-utils-1.28.0.tar.xz.asc
...
%setup -q -n v4l-utils-1.28.0
cd %{_builddir}/v4l-utils-1.28.0
pushd ..
cp -a v4l-utils-1.28.0 build32
popd
pushd ..
cp -a v4l-utils-1.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721681287
