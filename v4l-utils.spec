...
Source0  : https://linuxtv.org/downloads/v4l-utils/v4l-utils-1.12.3.tar.bz2
Source99 : https://linuxtv.org/downloads/v4l-utils/v4l-utils-1.12.3.tar.bz2.asc
...
%prep
%setup -q -n v4l-utils-1.12.3

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487765543
